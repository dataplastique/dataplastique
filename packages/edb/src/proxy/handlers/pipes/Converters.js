import { Type, IMap, ISet } from '@dataplastique/util';
...
/**
 * Users will input their models to our models and despair when we change
 * them, so we'll clone their input into fresh objects before we continue.
